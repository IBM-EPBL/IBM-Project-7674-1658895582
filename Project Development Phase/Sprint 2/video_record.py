...
class videos:
    def __init__(self, root,video_source=0):
        ...
        self.btn_start=tk.Button(self.root, text='START', command=self.open_camera)

        self.btn_start.pack(side=tk.LEFT)

        self.btn_stop=tk.Button(self.root, text='STOP', command=self.close_camera)
...
class VideoCapture:
    def __init__(self, video_source=0):
        ...
        self.out = cv2.VideoWriter("Video_Data/13-11-22"+args.name[0]+'.'+args.type[0],self.fourcc,10,res)
...
class CommandLineParser:
    ...
    def __init__(self):
        ...
        parser.add_argument('--name', nargs=1, default=['ForestData'], type=str, help='Enter Output video title/name')
